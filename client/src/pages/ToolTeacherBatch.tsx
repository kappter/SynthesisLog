      ...
      <header className="border-b border-[#e0d8cc] bg-white/80 backdrop-blur sticky top-0 z-10 print:hidden">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <Users className="w-4 h-4 text-[#b08060] shrink-0" />
            <span className="text-sm font-semibold text-[#2c2c2c] truncate">Teacher Batch Tool</span>
            <span className="hidden sm:inline text-xs text-[#8a7a6a] ml-1">— import class JSON files and generate a class-level overview</span>
          </div>
